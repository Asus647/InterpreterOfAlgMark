...
Приложение включает следующие предустановленные наборы:

Транслитерация - преобразование кириллицы в латиницу

Нормализация текста - очистка и форматирование текста

HTML-экранирование - экранирование специальных символов HTML

Очистка Markdown - удаление лишних пробелов в разметке
